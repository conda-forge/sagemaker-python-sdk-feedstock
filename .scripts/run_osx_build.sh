...
validate_recipe_outputs "sagemaker-python-sdk-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="sagemaker-python-sdk-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi